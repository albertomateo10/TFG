...
path_dataset_train = '/home/Dataset1/Train'
path_dataset_val = '/home/Dataset1/Val'
...
def train(model_path, lr_factor, lr_patience, lr_threshold, lr_min, num_epochs, train_loader, max_grad_norm, round_num):
    ...
    plt.legend()
    plt.title('Loss')
    plt.savefig(os.path.join(save_dir, f'model_flower_1_model_faster_rcnn_v2_SGD_1400x1050_00001_R{round_num}.png'))
